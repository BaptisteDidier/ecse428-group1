...
So that I can become a student and participate in dance classes
    ...
    Scenario: Successful registration with valid information (Normal Flow)
    ...
    Scenario: Registration with an email that is already in use (Error Flow)
    ...
    Scenario: Registration with invalid or incomplete details (Error Flow)
    ...
    Scenario: Registration with optional profile information skipped (Alternative Flow)
